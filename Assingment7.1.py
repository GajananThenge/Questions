# -*- coding: utf-8 -*-
"""
Created on Sun May 20 12:51:44 2018

@author: hp-pc
"""

'''
happens all the time: someone gives you data containing malformed strings, Python,
...
column).
'''
df['FlightNumber']=[10045+(45*i) for i in range(0,5)]
...
delays=pd.DataFrame()
delays[['delay_1','delay_2','delay_3']]=pd.DataFrame(df.RecentDelays.values.tolist())

result = pd.concat([df[['Airline','FlightNumber', 'From', 'To']],delays], axis=1)
